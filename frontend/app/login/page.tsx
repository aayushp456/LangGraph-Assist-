    ...
    <div className="min-h-screen bg-[#0b0f1a] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white tracking-tight">Support Agent</h1>
          <p className="text-slate-500 mt-2">Agent Dashboard Login</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-[#111827] rounded-xl border border-white/5 p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="agent@support.local"
            />
          </div>
          ...
          <div className="text-center pt-2">
            <Link href="/portal/login" className="text-xs text-slate-500 hover:text-slate-300 transition-colors">
              Customer? Login to portal instead
            </Link>
          </div>
        </form>

        <div className="text-center mt-4 text-xs text-slate-600">
          Default: agent@support.local / agent123
        </div>
      </div>
    </div>
  );
